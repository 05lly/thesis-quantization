...
for epoch in range(epochs):
    ...
    if val_acc > best_acc:
        best_acc = val_acc
        qat_path = os.path.join(model_dir, "resnet18_c100_qat_best_192.pth")
...
int8_weight_path = os.path.join(model_dir, "resnet18_c100_int8_192_final.pth")
torch.save(int8_model.state_dict(), int8_weight_path)
deploy_path = os.path.join(model_dir, "resnet18_c100_int8_deploy_192.pt")
traced_model = torch.jit.trace(int8_model, torch.randn(1, 3, 192, 192))
