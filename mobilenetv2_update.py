...
# --- 3. 模型准备 (混合精度修改) ---
log_message("Initializing MobileNetV2 for Mixed Precision (INT4+FP32) QAT (CIFAR-100)...")
...
# 2. 针对 MobileNetV2 保护首尾层
# features[0][0] 是第一层 3x3 卷积
# classifier[1] 是最后一层全连接层
...
log_message("=" * 60)
log_message(f" MobileNetV2 Mixed Precision INT4 QAT Final Report ")
