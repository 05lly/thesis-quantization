...
# --- 2. 日志函数 --- 
log_filename = os.path.join(log_dir, f"resnet18_c10_int4_qat_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
...
log_message("INT4 Quantization Aware Training (QAT) - ResNet18")
...
# 定义输出路径
deploy_path = os.path.join(model_dir, "resnet18_c10_int4_qat_deploy.pt")
...
log_message("=" * 70)
log_message("ResNet18 CIFAR-10 INT4 QAT Results")
log_message("=" * 70)
log_message(f"FP32 Accuracy: {fp32_acc:.2f}%")
