...
log_filename = os.path.join(
    log_dir,
    f"qat_int4_resnet18_c10_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log",
)
...
# --- 3. 模型准备 ---
log_message("Initializing ResNet18 for INT4 QAT (CIFAR-10)...")
...
for epoch in range(epochs):
    ...
    # CIFAR-10: 第 5 轮开始冻结 observer 和 BN stats
    if epoch > 3:
...
log_message("=" * 60)
log_message(" ResNet18 INT4 QAT Final Report (CIFAR-10) ")
