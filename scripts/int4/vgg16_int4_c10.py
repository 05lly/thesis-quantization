...
log_filename = os.path.join(
    log_dir,
    f"qat_int4_vgg16_c10_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log",
)
...
# --- 3. 模型准备 ---
log_message("Initializing VGG16 for INT4 QAT (CIFAR-10)...")
...
log_message("=" * 60)
log_message(" VGG16 INT4 QAT Final Report (CIFAR-10) ")
